...
return [
    ...
    // 官网
    'website' => [
        'name' => env('project.web_name', 'skyblue'), // 网站名称
        'url' => env('project.web_url', 'www.skyblue.cn/'), // 网站地址
    ...
    // 唯一标识，密码盐、路径加密等
    'unique_identification' => env('project.unique_identification', 'skyblue'),

    // 后台管理员token（登录令牌）配置
    'admin_token' => [
        'expire_duration' => 1000 * 60 * 30,//管理后台token过期时长(单位秒）
